...
;define("login_toolbar/main", ["require", "exports", "module"],
    function () {
        function a(o, n) {
            if (navigator.userAgent.indexOf("Firefox") > 0) $("#loginToolBar ." + o).html(n);
            else for (var a = $("#loginToolBar ." + o + " i"),
                          c = String(n).length, i = 0; c > i; i++) {
...
;define("jquery-ui.custom", ["require", "exports", "module"],
    function () {
        !
            function (a, h) {
                function c(h, c) {
...
;!
    function (h) {
        "use strict";
        "function" == typeof define && define.amd ? define("jquery.hoverdir", ["jquery"], h) : "undefined" != typeof exports ? module.exports = h(require("jquery")) : h(jQuery)
    }(function (h) {
        "use strict";
        function a(a, c) {
            this.$el = h(a),
...
;define("sidebar/main", ["require", "exports", "module"],
    function () {
        function h() {
...
;define("banner/main", ["require", "exports", "module"],
    function () {
        function a(a) {
            a >= 0 && (i = a),
        ...
        for (var b = $("#home_banner .banner_bg li a"),
                 h = "http://", i = 0; i < b.length; i++) {
            var c = $(b[i]).attr("href");
...
;define("job_list/main", ["require", "exports", "module",],
    function (require) {
        $(".newTab").on("click", function () {
            document.getElementById("new-work-posi").style.display = "block";
            document.getElementById("hot-work-posi").style.display = "none";
            $(".newTab").addClass("current");
            $(".hotTab").removeClass("current");

        });
        $(".hotTab").on("click", function () {
            document.getElementById("new-work-posi").style.display = "none";
            document.getElementById("hot-work-posi").style.display = "block";
...
;define("index/main", ["require", "exports", "module",
        "jquery-ui.custom",
        "sidebar/main",
        "jquery.hoverdir",
        "login_toolbar/main",
    ...
    function (require) {
            ...
            require("login_toolbar/main"),
            require("banner/main"),
            require("job_list/main")
